       ...
       <div style="position: absolute; top: 10px; right: 20px; display: flex; align-items: center;">
        ...
        <div class="box-wrapper">
            <div class="box-container">
                ...
                <div class="col-sm-6">
                    <div class="scrollable-container">
                        <h3 class="news-header" style="margin-bottom:37px;">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="blue" class="bi bi-facebook" viewBox="0 0 16 16" style="margin-right:10px;">
